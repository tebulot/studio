    ...
    <div className="space-y-8">
      <header className="mb-10">
        ...
        <p className="text-muted-foreground mt-2 text-lg">
          Explore upcoming API features designed to give you programmatic access to your tarpit data (powered by our Nightmare v2 engine) and broader threat intelligence.
        </p>
      </header>
      ...
      <section className="space-y-6">
        <Card className="shadow-lg border-accent/20">
          <CardHeader>
            ...
            <CardDescription>
              Gain direct access to raw, non-aggregated logs from your Nightmare v2 tarpit instances for detailed analysis and custom integration. These logs detail interactions with our Procedural Content Generation (PCG) layouts.
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-3 text-foreground/80">
            <p>While SpiteSpiral provides aggregated summaries, we are developing features to grant you access to the granular raw logs from your Nightmare v2 tarpit instances. This allows for deeper investigation and integration into your own security toolchains.</p>
            ...
            <ul className="list-disc pl-5 space-y-1">
              ...
              <li><strong>Reliable Log Collection:</strong> Our robust pipeline ensures raw logs from your Nightmare v2 tarpit instances are efficiently collected and made available.</li>
        ...
        <Card className="shadow-lg border-primary/20">
          <CardHeader>
            ...
            <CardDescription>
              Programmatically access data from your own managed Nightmare v2 tarpits for custom integrations and security workflows.
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-3 text-foreground/80">
            <p>This API will empower you to retrieve detailed information and statistics specific to your configured SpiteSpiral Nightmare v2 tarpit instances.</p>
            ...
            <ul className="list-disc pl-5 space-y-1">
              ...
              <li><strong>Comprehensive Data Access:</strong> Retrieve raw log lines, aggregated statistics, and specific indicators like frequent IPs (with ASN/network provider data) or User-Agents targeting your instances.</li>
        ...
        <Card className="shadow-lg border-accent/20">
          <CardHeader>
            ...
            <CardDescription>
              Access anonymized and aggregated threat data, including ASN (network provider) details, from across the entire SpiteSpiral Nightmare v2 platform to proactively identify and block known bad actors.
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-3 text-foreground/80">
            <p>This premium API will provide insights derived from activity across all SpiteSpiral Nightmare v2 tarpits, offering a broader view of threat landscapes and enabling proactive defense.</p>
            ...
            <ul className="list-disc pl-5 space-y-1">
              ...
              <li><strong>Actionable Threat Feeds:</strong> Data will be enriched with context, such as frequency, recency, and ASN (network provider) data, to help you prioritize and act on threats more effectively.</li>
              <li><strong>Easy-to-Integrate Feeds:</strong> Access global threat data via dedicated API endpoints (e.g., for top malicious IPs with their network providers) in standardized formats.</li>
