...
const faqData = [
  ...
  },
  {
    ...
    answer: (<><p>We aim for simplicity. The basic setup involves adding a specially crafted link to your website, pointing to our service. We provide clear instructions, including the crucial `robots.txt` configurations to protect your SEO.</p></>)
  },
  {
  ...
  return (
    <div className="relative flex flex-col items-center justify-center min-h-screen bg-background text-foreground font-mono p-8 selection:bg-primary selection:text-primary-foreground">
      ...
      <div className="relative z-10 text-center flex flex-col items-center w-full flex-grow">
        ...
        <div className="flex flex-col sm:flex-row gap-4 mb-10"> {/* Reduced mb from 20 to 10 */}
            <Button
              asChild
              size="lg"
