  ...
  return (
    <div className="relative flex flex-col items-center justify-center min-h-screen bg-background text-foreground font-mono p-8 selection:bg-primary selection:text-primary-foreground">
      ...
      <div className="relative z-10 text-center flex flex-col items-center w-full flex-grow">
        ...
        <h1 className="text-5xl md:text-7xl font-black font-sans mb-4 glitch-text tracking-wider">
          <span className="text-primary-foreground">Spite</span><span className="text-primary">Spiral</span>: Beyond Blocking.
        </h1>
        <h2 className="text-3xl md:text-5xl font-black font-sans mb-10 glitch-text tracking-wider text-accent">
        ...
        <div className="mt-10 mb-20 w-full max-w-5xl px-4">
